...
<sql:setDataSource dataSource="jdbc/ELDBy" var="activity" scope="application"/>
				...
				<div class="row" id="row-view"> 
					...
					<div id="content" class="6u skel-cell-important">
						<section>
							...
							<p style="text-align:center;font-size:15px;"><a href="${pageContext.request.contextPath}/activityPage/activitySimple2.jsp" style="text-decoration:none;" >回列表</a></p>
						</section>
					</div>
					</c:forEach>
