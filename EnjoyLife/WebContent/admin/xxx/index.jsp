			...
			function first(page){
				...
				$.getJSON("${pageContext.request.contextPath}/AdminSelectByShow",{"page":page,"show":0},function(data){
					...
					$.each(data,function(){
						...
						cat2no=this.cat2no;
						if(cat1no==101){
							$('#bd').append("<tr name='onedata' value="+attracno+"><td name='attracno'>"+attracno+"</td><td name='stitle'>"+stitle+"</td><td name='time'>"+time+"</td><td>"+cate1+"</td><td name='hide'>"+cate21+"<input type='hidden' name='address' value="+address+"><input type='hidden' name='county' value="+county+"><input type='hidden' name='dist' value="+dist+"><input type='hidden' name='info' value="+info+"><input type='hidden' name='mrt' value="+mrt+"><input type='hidden' name='xbody' value="+xbody+"></td></tr>");
							$('tr[value='+attracno+']').find('select[name=cate1]').val(cat2no).prop("disabled", true);
						}else{
							$('#bd').append("<tr name='onedata'><td name='attracno'>"+attracno+"</td><td name='stitle'>"+stitle+"</td><td name='time'>"+time+"</td><td>"+cate1+"</td><td name='hide'>"+cate22+"<input type='hidden' name='address' value="+address+"><input type='hidden' name='county' value="+county+"><input type='hidden' name='dist' value="+dist+"><input type='hidden' name='info' value="+info+"><input type='hidden' name='mrt' value="+mrt+"><input type='hidden' name='xbody' value="+xbody+"></td></tr>");
