	...
	<nav id="nav">
		<ul>
			...
			<c:if test="${!empty member}">							
				...
				<li><img src="${pageContext.request.contextPath}/GetImg?imgid=${member.picture}" height="35" width="35" onerror="this.style.display='none'"> 
					${member.memberName}
				</li>
			</c:if>	
		</ul>
										...
										<tr>
											<td>
												<div>
													...
													<a href="#" data-toggle="modal" data-target="#myModal3" onclick="attend('${mem.PartnerVO.eventNo}','${member.memberId}','${mem.PartnerVO.memberId}')"><img style="margin-left:130px" src="img/plusone2.png"
