...
<sql:setDataSource dataSource="jdbc/activity" var="activity" scope="application"/>
  <sql:query var="rs" dataSource="${activity}">
  			...
  			AS 'RowNo', * from [activity]) as t where t.RowNo between 21 and 25
  </sql:query>
		...
		<div id="main">
			<div class="container">
				...
				<nav class="dopage" style="text-align: center">
  					<ul class="pagination" >
    					<li><a href="activitySimple4.jsp"><span aria-hidden="true">&laquo;</span><span class="sr-only">Previous</span></a></li>
    					...
    					<li class="active"><a href="activitySimple5.jsp">5</a></li>
    					<li><a href="activitySimple6.jsp">6</a></li>
    					<li><a href="activitySimple6.jsp"><span aria-hidden="true">&raquo;</span><span class="sr-only">Next</span></a></li>
  					</ul>
				</nav>
			</div>
		</div>
