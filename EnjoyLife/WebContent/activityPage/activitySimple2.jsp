		...
		<div id="main">
			<div class="container">
				...
				<nav class="dopage" style="text-align: center">
  					<ul class="pagination" >
    					<li><a href="activitySimple1.jsp"><span aria-hidden="true">&laquo;</span><span class="sr-only">Previous</span></a></li>
    					<li><a href="activitySimple1.jsp">1</a></li>
    					<li class="active"><a href="activitySimple2.jsp">2</a></li>
    					...
    					<li><a href="activitySimple3.jsp"><span aria-hidden="true">&raquo;</span><span class="sr-only">Next</span></a></li>
  					</ul>
				</nav>
			</div>
		</div>
