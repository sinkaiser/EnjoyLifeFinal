...
<sql:setDataSource dataSource="jdbc/ELDB" var="activity" scope="application"/>
  <sql:query var="rs" dataSource="${activity}">
  			...
  			AS 'RowNo', * from [activity]) as t where t.RowNo between 26 and 30
  </sql:query>
		...
		<div id="main">
			<div class="container">
				...
				<nav class="dopage" style="text-align: center">
  					<ul class="pagination" >
    					<li><a href="activitySimple5.jsp"><span aria-hidden="true">&laquo;</span><span class="sr-only">Previous</span></a></li>
    					...
    					<li class="active"><a href="activitySimple6.jsp">6</a></li>
