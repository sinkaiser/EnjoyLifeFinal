...
public class AjaxMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		attendPartnerVO.setPartnerId(messageFrom);
		...
		vo.setMessage(memberName+"想參加你的活動。他留給你的訊息："+message+"<br>是否同意一起呢？  <a target='blank' href='http://localhost:8080/EnjoyLife/partner/CloseEventServlet?eno3="+eno+"'><button>同意</button></a><button>拒絕</button>");
