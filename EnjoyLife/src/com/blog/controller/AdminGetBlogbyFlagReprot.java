 ...
 */
@WebServlet("/AdminGetBlogbyFlagReprot")
public class AdminGetBlogbyFlagReprot extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminGetBlogbyFlagReprot() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<BlogVO> vos=dao.selectByFlagReport(Integer.parseInt(page));
